...
static float reset (Params params, State* state, int num_channels, float sample_rate, float vi_dc = 0.0f)
{
    ...
    const auto zC1 = (-((gC1 * ((D1N914_Is * (exp((vD1D2 / D1N914_vt)) - (1.0f / exp((vD1D2 / D1N914_vt))))) - (gR1 * vi))) / (gR1 + (1.0f / 1000000000.0f))));

    const auto vo_dc_out = (-(((D1N914_Is * (exp((vD1D2 / D1N914_vt)) - (1.0f / exp((vD1D2 / D1N914_vt))))) - (gR1 * vi)) / (gR1 + (1.0f / 1000000000.0f))));
