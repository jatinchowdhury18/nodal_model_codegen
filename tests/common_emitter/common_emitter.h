...
static void compute (const float* const* input, float** output, int num_channels, int num_samples, Params params, State* state, float sample_rate)
{
    ...
    const auto _t7 = (1 / ((_t0 * _t8) - (gC2 * gC2)));
    const auto _t9 = (_t6 * gC2);
    const auto _t10 = (gR1 * VCC);
    const auto _t11 = (1 / ((gC1 + gR1) + gR2));
    ...
    for (int ch = 0; ch < num_channels; ++ch)
    {
        ...
        for (int n = 0; n < num_samples; ++n)
        {
            ...
            const auto _Q1_t23 = (1 / (((gRC + gC2) * _Q1_t22) - (gC2 * gC2)));
            const auto _Q1_t29 = (1 / (Q2N5089_vt * Q2N5089_BetaF));
            const auto _Q1_t39 = (1 / (Q2N5089_vt * Q2N5089_BetaR));
            const auto _Q1_t15 = (_Q1_t16 - zC1);
            const auto _Q1_t17 = (1 / (_Q1_t18 + gR2));
            ...
            for (int newton_iter = 0; newton_iter < newton_max_iter; ++newton_iter)
            {
                ...
                const auto _Q1_t8 = (_Q1_t9 - 1);
                const auto _Q1_t12 = (_Q1_t13 - 1);
                ...
                const auto _Q1_t25 = ((_Q1_t26 + (((_Q1_t30 / Q2N5089_BetaF) + _Q1_t30) / gRE)) + 1);
                const auto _Q1_t35 = ((_Q1_t36 + ((_Q1_t40 * _Q1_t22) * _Q1_t23)) + 1);
...
static void reset (Params params, State* state, int num_channels, float sample_rate, float vi_dc = 0.0f)
{
    ...
    // --- Newton-Raphson solve: Q1
    const auto _Q1_t3 = (gR1 * VCC);
    const auto _Q1_t14 = (1 / (gR1 + gR2));
    const auto _Q1_t23 = (1 / (Q2N5089_vt * Q2N5089_BetaF));
    const auto _Q1_t33 = (1 / (Q2N5089_vt * Q2N5089_BetaR));
    const auto _Q1_t39 = (VCC * gRC);
    for (int newton_iter = 0; newton_iter < newton_max_iter; ++newton_iter)
    {
        ...
        const auto _Q1_t17 = (_Q1_t8 - _Q1_t12);
        const auto _Q1_t22 = (Q2N5089_Is * _Q1_t8);
        const auto _Q1_t24 = (_Q1_t22 / Q2N5089_vt);
        const auto _Q1_t32 = (Q2N5089_Is * _Q1_t12);
        const auto _Q1_t36 = (_Q1_t12 / Q2N5089_vt);
        const auto _Q1_t37 = (_Q1_t36 / Q2N5089_BetaR);
        const auto _Q1_t7 = (_Q1_t8 - 1);
        const auto _Q1_t11 = (_Q1_t12 - 1);
        const auto _Q1_t21 = (_Q1_t22 * _Q1_t23);
        const auto _Q1_t31 = (_Q1_t32 * _Q1_t33);
        const auto _Q1_t35 = (_Q1_t36 + _Q1_t37);
        const auto _Q1_t6 = (_Q1_t7 / Q2N5089_BetaF);
        const auto _Q1_t10 = (_Q1_t11 / Q2N5089_BetaR);
        const auto _Q1_t16 = (_Q1_t17 - _Q1_t10);
        const auto _Q1_t20 = (_Q1_t21 * _Q1_t14);
        const auto _Q1_t25 = ((_Q1_t24 / gRC) - _Q1_t20);
        const auto _Q1_t30 = (_Q1_t31 * _Q1_t14);
        const auto _Q1_t34 = (Q2N5089_Is * _Q1_t35);
        const auto _Q1_t38 = (_Q1_t30 + ((((_Q1_t32 / Q2N5089_vt) / Q2N5089_BetaR) - _Q1_t34) / gRE));
        const auto _Q1_t5 = (_Q1_t6 + _Q1_t10);
        const auto _Q1_t15 = (Q2N5089_Is * _Q1_t16);
        const auto _Q1_t19 = ((_Q1_t20 + (((_Q1_t24 / Q2N5089_BetaF) + _Q1_t24) / gRE)) + 1);
        const auto _Q1_t29 = ((_Q1_t30 + (_Q1_t34 / gRC)) + 1);
        const auto _Q1_t4 = (Q2N5089_Is * _Q1_t5);
        const auto _Q1_t28 = ((_Q1_t29 * _Q1_t19) + (_Q1_t25 * _Q1_t38));
        const auto _Q1_t2 = (_Q1_t3 - _Q1_t4);
        const auto _Q1_t1 = (_Q1_t2 * _Q1_t14);
        const auto _Q1_t27 = (_Q1_t1 - ((_Q1_t4 + _Q1_t15) / gRE));
        const auto _Q1_t0 = (_Q1_t1 + ((_Q1_t15 - _Q1_t39) / gRC));
        const auto _Q1_t18 = (vBCQ1 - _Q1_t0);
        const auto _Q1_t26 = (vBEQ1 - _Q1_t27);
        const auto res_vBCQ1 = (_Q1_t0 - vBCQ1);
        const auto delta_vBCQ1 = (-(((_Q1_t18 * _Q1_t19) + (_Q1_t25 * _Q1_t26)) / _Q1_t28));
        const auto res_vBEQ1 = (_Q1_t27 - vBEQ1);
        const auto delta_vBEQ1 = (((_Q1_t18 * _Q1_t38) - (_Q1_t29 * _Q1_t26)) / _Q1_t28);
    ...
    const auto zC1 = (gC1 * (vi - (((gR1 * VCC) - (Q2N5089_Is * (((exp((vBEQ1 / Q2N5089_vt)) - 1) / Q2N5089_BetaF) + ((exp((vBCQ1 / Q2N5089_vt)) - 1) / Q2N5089_BetaR)))) / (gR1 + gR2))));
    const auto zC2 = (-((gC2 * ((Q2N5089_Is * ((exp((vBEQ1 / Q2N5089_vt)) - exp((vBCQ1 / Q2N5089_vt))) - ((exp((vBCQ1 / Q2N5089_vt)) - 1) / Q2N5089_BetaR))) - (VCC * gRC))) / gRC));
