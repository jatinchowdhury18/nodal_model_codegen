// Auto-generated with netlist_codegen version a2974f6.
...
vD1 = limit_junction_voltage(vD1 + (_prev_step), vD1, D1N914_vt, vcrit_D1N914_vt);
            ...
            {
                ++nr_iters_X1_X2_D1;
                const auto _X1_X2_D1_pt3 = math_exp_approx((_12AX7_DEMPWOLF_Ck * ((vPKX1 / _12AX7_DEMPWOLF_Mu) + vGKX1)));
                const auto _X1_X2_D1_pt9 = (_12AX7_DEMPWOLF_Cg * vGKX1);
                const auto _X1_X2_D1_pt17 = math_exp_approx((_12AX7_DEMPWOLF_Ck * ((vPKX2 / _12AX7_DEMPWOLF_Mu) + vGKX2)));
                const auto _X1_X2_D1_pt26 = (_12AX7_DEMPWOLF_Cg * vGKX2);
                const auto _X1_X2_D1_pt27 = (vD1 / D1N914_vt);
                const auto _X1_X2_D1_pt43 = math_exp_approx(_X1_X2_D1_pt27);
                const auto _X1_X2_D1_pt2 = (1.0 + _X1_X2_D1_pt3);
                const auto _X1_X2_D1_pt8 = math_exp_approx(_X1_X2_D1_pt9);
                const auto _X1_X2_D1_pt16 = (1.0 + _X1_X2_D1_pt17);
                const auto _X1_X2_D1_pt23 = math_exp_approx(_X1_X2_D1_pt26);
                const auto _X1_X2_D1_pt1 = (math_log_approx(_X1_X2_D1_pt2) / _12AX7_DEMPWOLF_Ck);
                const auto _X1_X2_D1_pt7 = (1.0 + _X1_X2_D1_pt8);
                const auto _X1_X2_D1_pt15 = (math_log_approx(_X1_X2_D1_pt16) / _12AX7_DEMPWOLF_Ck);
                const auto _X1_X2_D1_pt22 = (1.0 + _X1_X2_D1_pt23);
                const auto _X1_X2_D1_pt38 = math_pow_approx(_X1_X2_D1_pt15, _X1_X2_D1_pt4);
                const auto _X1_X2_D1_pt0 = math_pow_approx(_X1_X2_D1_pt1, _X1_X2_D1_pt4);
                const auto _X1_X2_D1_pt6 = math_log_approx(_X1_X2_D1_pt7);
                const auto _X1_X2_D1_pt14 = (_X1_X2_D1_pt6 / _12AX7_DEMPWOLF_Cg);
                const auto _X1_X2_D1_pt21 = math_log_approx(_X1_X2_D1_pt22);
                const auto _X1_X2_D1_pt28 = (_X1_X2_D1_pt0 * _X1_X2_D1_pt3);
                const auto _X1_X2_D1_pt30 = (_12AX7_DEMPWOLF_Gamma * _X1_X2_D1_pt28);
                const auto _X1_X2_D1_pt37 = (_X1_X2_D1_pt38 * _X1_X2_D1_pt17);
                const auto _X1_X2_D1_pt13 = math_pow_approx(_X1_X2_D1_pt14, _X1_X2_D1_pt10);
                const auto _X1_X2_D1_pt20 = (_X1_X2_D1_pt21 / _12AX7_DEMPWOLF_Cg);
                const auto _X1_X2_D1_pt25 = math_pow_approx(_X1_X2_D1_pt20, _X1_X2_D1_pt10);
                const auto _X1_X2_D1_pt29 = (_12AX7_DEMPWOLF_Gk * _X1_X2_D1_pt30);
                const auto _X1_X2_D1_pt31 = (_X1_X2_D1_pt13 * _X1_X2_D1_pt8);
                const auto _X1_X2_D1_pt34 = (_12AX7_DEMPWOLF_Xi * _X1_X2_D1_pt31);
                const auto _X1_X2_D1_pt36 = (_12AX7_DEMPWOLF_Gamma * _X1_X2_D1_pt37);
                const auto _X1_X2_D1_pt42 = (_X1_X2_D1_pt25 * _X1_X2_D1_pt23);
                const auto _X1_X2_D1_pt12 = (_X1_X2_D1_pt13 * _X1_X2_D1_pt14);
                const auto _X1_X2_D1_pt19 = (_X1_X2_D1_pt25 * _X1_X2_D1_pt20);
                const auto _X1_X2_D1_pt24 = (_12AX7_DEMPWOLF_Gg * _X1_X2_D1_pt19);
                const auto _X1_X2_D1_pt33 = (_12AX7_DEMPWOLF_Gg * _X1_X2_D1_pt34);
                const auto _X1_X2_D1_pt35 = (_12AX7_DEMPWOLF_Gk * _X1_X2_D1_pt36);
                const auto _X1_X2_D1_pt39 = (_12AX7_DEMPWOLF_Xi * _X1_X2_D1_pt42);
                const auto _X1_X2_D1_pt41 = (_12AX7_DEMPWOLF_Gg * _X1_X2_D1_pt39);
                const auto _X1_X2_D1_pt11 = (_12AX7_DEMPWOLF_Gg * _X1_X2_D1_pt12);
                const auto _X1_X2_D1_pt18 = (_X1_X2_D1_pt24 + _12AX7_DEMPWOLF_Ig0);
                const auto _X1_X2_D1_pt32 = (_X1_X2_D1_pt33 / _X1_X2_D1_pt7);
                const auto _X1_X2_D1_pt40 = (_X1_X2_D1_pt41 / _X1_X2_D1_pt22);
                const auto _X1_X2_D1_pt5 = (_X1_X2_D1_pt11 + _12AX7_DEMPWOLF_Ig0);
                const auto _X1_X2_D1_i0 = ((_12AX7_DEMPWOLF_Gk * (_X1_X2_D1_pt0 * _X1_X2_D1_pt1)) - _X1_X2_D1_pt5);
                const auto _X1_X2_D1_i1 = _X1_X2_D1_pt5;
                const auto _X1_X2_D1_i2 = ((_12AX7_DEMPWOLF_Gk * (_X1_X2_D1_pt38 * _X1_X2_D1_pt15)) - _X1_X2_D1_pt18);
                const auto _X1_X2_D1_i3 = _X1_X2_D1_pt18;
                const auto _X1_X2_D1_i4 = (D1N914_Is * (_X1_X2_D1_pt43 - 1.0));
                const auto _X1_X2_D1_g0_0 = (_X1_X2_D1_pt29 / (_12AX7_DEMPWOLF_Mu * _X1_X2_D1_pt2));
                const auto _X1_X2_D1_g0_1 = ((_X1_X2_D1_pt29 / _X1_X2_D1_pt2) - _X1_X2_D1_pt32);
                const auto _X1_X2_D1_g1_0 = 0.0;
                const auto _X1_X2_D1_g1_1 = _X1_X2_D1_pt32;
                const auto _X1_X2_D1_g2_2 = (_X1_X2_D1_pt35 / (_12AX7_DEMPWOLF_Mu * _X1_X2_D1_pt16));
                const auto _X1_X2_D1_g2_3 = ((_X1_X2_D1_pt35 / _X1_X2_D1_pt16) - _X1_X2_D1_pt40);
                const auto _X1_X2_D1_g3_2 = 0.0;
                const auto _X1_X2_D1_g3_3 = _X1_X2_D1_pt40;
