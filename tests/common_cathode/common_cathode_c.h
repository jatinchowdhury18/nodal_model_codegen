    ...
    for (int ch = 0; ch < num_channels; ++ch)
    {
        ...
        for (int n = 0; n < num_samples; ++n)
        {
            ...
            for (int newton_iter = 0; newton_iter < newton_max_iter; ++newton_iter)
            {
                ...
                const double _X1_t17 = math_exp_approx(_X1_t18);
                const double _X1_t8 = (_12AX7_DEMPWOLF_Ck * _X1_t9);
                const double _X1_t16 = (1.0 + _X1_t17);
                const double _X1_t7 = math_exp_approx(_X1_t8);
                const double _X1_t15 = math_log_approx(_X1_t16);
                const double _X1_t6 = (1.0 + _X1_t7);
                const double _X1_t14 = (_X1_t15 / _12AX7_DEMPWOLF_Cg);
                const double _X1_t36 = math_pow_approx(_X1_t14, _X1_t37);
                const double _X1_t54 = (_X1_t36 * _X1_t17);
                const double _X1_t66 = (_12AX7_DEMPWOLF_Mu * _X1_t6);
                const double _X1_t5 = math_log_approx(_X1_t6);
                const double _X1_t13 = math_pow_approx(_X1_t14, _12AX7_DEMPWOLF_Xi);
                ...
                const double _X1_t49 = math_pow_approx(_X1_t4, _X1_t50);
                const double _X1_t52 = (_12AX7_DEMPWOLF_Gg * _X1_t53);
                const double _X1_t3 = math_pow_approx(_X1_t4, _12AX7_DEMPWOLF_Gamma);
            ...
            const double _t5 = (_12AX7_DEMPWOLF_Gg * math_pow_approx((math_log_approx((1.0 + math_exp_approx((_12AX7_DEMPWOLF_Cg * vGKX1)))) / _12AX7_DEMPWOLF_Cg), _12AX7_DEMPWOLF_Xi));
            const double _t4 = (_t5 + _12AX7_DEMPWOLF_Ig0);
            const double _t3 = ((_12AX7_DEMPWOLF_Gk * math_pow_approx((math_log_approx((1.0 + math_exp_approx((_12AX7_DEMPWOLF_Ck * ((vPKX1 / _12AX7_DEMPWOLF_Mu) + vGKX1))))) / _12AX7_DEMPWOLF_Ck), _12AX7_DEMPWOLF_Gamma)) - _t4);
...
static float reset (Params params, State* state, int num_channels, float sample_rate, float vi_dc)
{
    ...
    for (int newton_iter = 0; newton_iter < 10000; ++newton_iter)
    {
        ...
        const double _X1_t18 = math_exp_approx(_X1_t19);
        const double _X1_t9 = (_12AX7_DEMPWOLF_Ck * _X1_t10);
        const double _X1_t17 = (1.0 + _X1_t18);
        const double _X1_t8 = math_exp_approx(_X1_t9);
        const double _X1_t16 = math_log_approx(_X1_t17);
        const double _X1_t7 = (1.0 + _X1_t8);
        const double _X1_t15 = (_X1_t16 / _12AX7_DEMPWOLF_Cg);
        const double _X1_t38 = math_pow_approx(_X1_t15, _X1_t39);
        const double _X1_t52 = (_12AX7_DEMPWOLF_Mu * _X1_t7);
        const double _X1_t6 = math_log_approx(_X1_t7);
        const double _X1_t14 = math_pow_approx(_X1_t15, _12AX7_DEMPWOLF_Xi);
        ...
        const double _X1_t32 = math_pow_approx(_X1_t5, _X1_t33);
        const double _X1_t36 = (_12AX7_DEMPWOLF_Xi * _X1_t37);
        const double _X1_t50 = (_X1_t51 * _X1_t32);
        const double _X1_t4 = math_pow_approx(_X1_t5, _12AX7_DEMPWOLF_Gamma);
