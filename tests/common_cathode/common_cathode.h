...
static void compute (const float* const* input, float** output, int num_channels, int num_samples, Params params, State* state, float sample_rate)
{
    ...
    const auto _t4 = (gCout * gRkCk);
    const auto _t5 = (VCC * gRkCk);
    const auto _t8 = (gCout + gRL);
    const auto _t7 = (_t8 * gRkCk);
    const auto _t6 = (1.0 / ((gCout * _t4) - (_t0 * _t7)));
...
vGKX1 = vGKX1 + (_prev_step);
            ...
            const auto _X1_zt17 = c0__X1_zt17 + c__X1_zt17[0] * vi + c__X1_zt17[1] * zCin + c__X1_zt17[2] * zCout + c__X1_zt17[3] * zRkCk;
            const auto _X1_zt16 = (gCout * zRkCk);
            const auto _X1_zt18 = (gCout * _X1_zt16);
            const auto _X1_zt20 = (_X1_zt14 * zRkCk);
            const auto _X1_zt19 = (_X1_zt10 * _X1_zt20);
            const auto _X1_pt12 = (_12AX7_DEMPWOLF_Xi - 1.0);
            const auto _X1_pt17 = (_12AX7_DEMPWOLF_Gamma - 1.0);
            for (int newton_iter = 0; newton_iter < newton_max_iter; ++newton_iter)
            {
                ...
                const auto _X1_pt4 = math_exp_approx(_X1_pt5);
                const auto _X1_pt11 = (1.0 + _X1_pt4);
                const auto _X1_pt0 = (math_log_approx(_X1_pt1) / _12AX7_DEMPWOLF_Ck);
                const auto _X1_pt10 = math_log_approx(_X1_pt11);
                const auto _X1_pt16 = math_pow_approx(_X1_pt0, _X1_pt17);
                const auto _X1_pt3 = (_X1_pt10 / _12AX7_DEMPWOLF_Cg);
                const auto _X1_pt9 = math_pow_approx(_X1_pt3, _X1_pt12);
                const auto _X1_pt14 = (_X1_pt16 * _X1_pt2);
                const auto _X1_pt19 = (_X1_pt9 * _X1_pt4);
                const auto _X1_pt21 = (_12AX7_DEMPWOLF_Xi * _X1_pt19);
                const auto _X1_pt8 = (_X1_pt9 * _X1_pt3);
                const auto _X1_pt13 = (_12AX7_DEMPWOLF_Gamma * _X1_pt14);
                const auto _X1_pt15 = (_12AX7_DEMPWOLF_Gk * _X1_pt13);
                const auto _X1_pt20 = (_12AX7_DEMPWOLF_Gg * _X1_pt21);
                const auto _X1_pt7 = (_12AX7_DEMPWOLF_Gg * _X1_pt8);
                const auto _X1_pt18 = (_X1_pt20 / _X1_pt11);
                const auto _X1_pt6 = (_X1_pt7 + _12AX7_DEMPWOLF_Ig0);
                const auto _X1_i0 = ((_12AX7_DEMPWOLF_Gk * (_X1_pt16 * _X1_pt0)) - _X1_pt6);
                const auto _X1_i1 = _X1_pt6;
                const auto _X1_g0_0 = (_X1_pt15 / (_12AX7_DEMPWOLF_Mu * _X1_pt1));
                const auto _X1_g0_1 = ((_X1_pt15 / _X1_pt1) - _X1_pt18);
            ...
            const auto _t3 = (_12AX7_DEMPWOLF_Gg * math_pow_approx((math_log_approx((1.0 + math_exp_approx((_12AX7_DEMPWOLF_Cg * vGKX1)))) / _12AX7_DEMPWOLF_Cg), _12AX7_DEMPWOLF_Xi));
            const auto _t9 = (_t3 + _12AX7_DEMPWOLF_Ig0);
            const auto _t10 = (zCout * gRkCk);
            const auto _t2 = ((_12AX7_DEMPWOLF_Gk * math_pow_approx((math_log_approx((1.0 + math_exp_approx((_12AX7_DEMPWOLF_Ck * ((vPKX1 / _12AX7_DEMPWOLF_Mu) + vGKX1))))) / _12AX7_DEMPWOLF_Ck), _12AX7_DEMPWOLF_Gamma)) - _t9);
            const auto _t11 = ((zRkCk + _t2) + _t9);
            const auto _t1 = (_t2 - zCout);
            const auto vo = ((((_t0 * _t10) + (_t1 * _t4)) - _t12) * _t6);
            const auto vg = (-((_t9 - ((gCin * vi) - zCin)) * _t13));
            const auto tCin = (gCin * (vi - vg));
            const auto vpl = ((((_t1 * _t7) + (gCout * _t10)) - _t14) * _t6);
            const auto tCout = (gCout * (vpl - vo));
            const auto vk = (((gCout * (gCout * _t11)) - (_t0 * (_t8 * _t11))) * _t6);
...
static float reset (Params params, State* state, int num_channels, float sample_rate, float vi_dc = 0.0f)
{
    ...
    const auto _X1_pt13 = (_12AX7_DEMPWOLF_Xi - 1.0);
    const auto _X1_pt17 = (_12AX7_DEMPWOLF_Gamma - 1.0);
    for (int newton_iter = 0; newton_iter < 10000; ++newton_iter)
    {
        const auto _X1_pt3 = math_exp_approx((_12AX7_DEMPWOLF_Ck * ((vPKX1 / _12AX7_DEMPWOLF_Mu) + vGKX1)));
        const auto _X1_pt12 = (_12AX7_DEMPWOLF_Cg * vGKX1);
        const auto _X1_pt2 = (1.0 + _X1_pt3);
        const auto _X1_pt11 = math_exp_approx(_X1_pt12);
        const auto _X1_pt1 = (math_log_approx(_X1_pt2) / _12AX7_DEMPWOLF_Ck);
        const auto _X1_pt10 = (1.0 + _X1_pt11);
        const auto _X1_pt0 = math_pow_approx(_X1_pt1, _X1_pt17);
        const auto _X1_pt9 = math_log_approx(_X1_pt10);
        const auto _X1_pt14 = (_X1_pt0 * _X1_pt3);
        const auto _X1_pt16 = (_12AX7_DEMPWOLF_Gamma * _X1_pt14);
        const auto _X1_pt8 = (_X1_pt9 / _12AX7_DEMPWOLF_Cg);
        const auto _X1_pt15 = (_12AX7_DEMPWOLF_Gk * _X1_pt16);
        const auto _X1_pt7 = math_pow_approx(_X1_pt8, _X1_pt13);
        const auto _X1_pt21 = (_X1_pt7 * _X1_pt11);
        const auto _X1_pt6 = (_X1_pt7 * _X1_pt8);
        const auto _X1_pt18 = (_12AX7_DEMPWOLF_Xi * _X1_pt21);
        const auto _X1_pt20 = (_12AX7_DEMPWOLF_Gg * _X1_pt18);
        const auto _X1_pt5 = (_12AX7_DEMPWOLF_Gg * _X1_pt6);
        const auto _X1_pt19 = (_X1_pt20 / _X1_pt10);
        const auto _X1_pt4 = (_X1_pt5 + _12AX7_DEMPWOLF_Ig0);
        const auto _X1_i0 = ((_12AX7_DEMPWOLF_Gk * (_X1_pt0 * _X1_pt1)) - _X1_pt4);
        const auto _X1_i1 = _X1_pt4;
        const auto _X1_g0_0 = (_X1_pt15 / (_12AX7_DEMPWOLF_Mu * _X1_pt2));
        const auto _X1_g0_1 = ((_X1_pt15 / _X1_pt2) - _X1_pt19);
        const auto _X1_g1_0 = 0.0;
        const auto _X1_g1_1 = _X1_pt19;
        const auto _X1_pt22 = ((_X1_voc0 + (_X1_Z0_0 * _X1_i0)) + (_X1_Z0_1 * _X1_i1));
